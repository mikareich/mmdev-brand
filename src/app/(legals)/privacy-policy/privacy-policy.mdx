<Section>
	<Section.Title level="1">Datenschutzerklärung</Section.Title>
...
Für Verbesserungsvorschläge hinsichtlich der Texte in dieser Datenschutzerklärung, oder wenn Sie einen Externen Datenschutzbeauftragten benötigen, wenden Sie sich bitte an den Urheber der Texte: [Prof. Dr. h.c. Heiko Jonny Maniero, LL.B., LL.M. mult., M.L.E.](https://www.linkedin.com/in/heikomaniero/).
...
Diese Datenschutzerklärung wurde durch die Nutzung eines Generators erstellt, der gemeinsam von [Datenschutzanwälten](https://www.wbs.legal/), [externen Datenschutzbeauftragten](https://dg-datenschutz.de/) und der [ISO 14001 Zertifizierungsstelle](https://cert-authority.com/) entwickelt wurde.
	</Section.Content>
</Section>
